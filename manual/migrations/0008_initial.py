...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('manual', '0007_delete_createprice_delete_indicator_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typeSale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='choice_of_Types_b', to='manual.createproduct')),
                ('unitSale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='choice_of_Units_b', to='manual.createproduct')),
            ],
            options={
